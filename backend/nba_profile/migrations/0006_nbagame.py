...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('nba_profile', '0005_userteam_name'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visitor_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='away_games', to='nba_profile.NBATeam')),
            ],
        ),
    ]
